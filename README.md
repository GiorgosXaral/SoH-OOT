For version Ackbar Delta 9.2.3 / https://github.com/HarbourMasters/Shipwright/releases/tag/9.2.3
...
every 90 frames and every 60 in the later phases. Once the tendrils are gone, the zappers charge their lightning at double speed.

Phantom Ganon — 30 → 60 hits
New lightning storm: after he's lost a third of his health, a 30% chance each cycle to call down two strikes near you, three once he's badly hurt.
Green light gathers where each bolt will land, so it's dodgeable. He also switches to his aggressive endgame pattern at half health rather 
than only when nearly dead.

Volvagia — 24 → 48 hits
Rocks fall on your position when it roars and when it emerges. Chases 400 frames instead of 300, rock storms last 210 instead of 150 with rocks every 12 frames
instead of 16. Idle time between attacks cut to three quarters. Repeats a claw swipe if you're still within range, and repeats fire breath when enraged. 
Enraged: rock storm chains straight into a chase, chase speed up to 7, rocks every 8 frames, plus a rock on your head with every roar.

Morpha — 20 → 40 hits
Tentacle attacks come with much less downtime, swing windup 36 frames instead of 50, and the second tentacle appears after 2 hits instead of 3. 
